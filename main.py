...
def search_for_nodes(head_node: Ingredient,  # todo finish
    ...
    """return a list of all the nodes in the ingredient tree with the same ingredient name"""
    ...
    return_list: list = []
    for _ in range(pillar_nodes.size):
        return_list.append(pillar_nodes.remove_back())
    return return_list
